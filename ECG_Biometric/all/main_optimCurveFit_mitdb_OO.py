...
clsfy_methods = ['SVM', 'DL', 'boosting', 'kNN', 'Logit', 'GNB']
...
if (strategy=='allN_data') or (strategy=='all_data'):
    ...
    #   print i, Counter(annss[i][1])['N'], Counter(annss[i][1])['V']
    #quit()
...
if strategy != 'NV_data':
    ...
    for i in range(len(NV_inds)):
        ...
        train_num_Vs = int(curr_num_Vs*ratio_testV)
